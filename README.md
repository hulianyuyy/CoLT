...
<div align="center">
  <img src="./assets/effciency.png" alt="Descriptive alt text" width="90%">
</div>
...
``your_benchmark`` should be selected from the supported benchmarks by VLMEvalKit, where you can find them [here](https://aicarrier.feishu.cn/wiki/Qp7wwSzQ9iK1Y6kNUJVcr6zTnPe?table=tblsdEpLieDoCxtb&view=vewUH3kRGs). 
